...
(function(d,e){var b=wp.media.view.l10n="undefined"===typeof _wpMediaViewsL10n?{}:_wpMediaViewsL10n,a=-1<navigator.userAgent.indexOf("Chrome"),f=!a&&-1<navigator.userAgent.indexOf("Safari"),b=_.extend(b,cheese_l10n),c={supports:{paste:!f&&cheese_l10n.enable_pasteboard&&("paste"in document||"onpaste"in document||"object"===typeof window.onpaste),webcam_recording:cheese_l10n.enable_snapshot&&d.recorder.supported&&(!a||a&&"https:"===location.protocol)},view:{},wpUloader:!1,getWpUploader:function(){return c.wpUploader}};
e.cheese=c})(jQuery,wp.media);
