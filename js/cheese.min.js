...
[b.element,c]):(b.trigger(a.Event("recorder:state:error"),[b.element,c]),console.log(c))});this.state="waiting";this.trigger(a.Event("recorder:state:waiting"),this.element)},stop:function(){var b,c;if(d&&d.stop)d.stop();else if(d.getVideoTracks)for(c in b=d.getVideoTracks(),b)b[c].stop&&b[c].stop();a(this.element).off("playing");this.state="stopped";this.trigger(a.Event("recorder:state:stopped"),this.element)},snapshot:function(){var b,c;b=this.element.videoWidth||this.width();c=this.element.videoHeight||
this.height();if(d){var f=a('<canvas style="display:block"></canvas>').insertAfter(this).attr("width",b).attr("height",c);f.get(0).getContext("2d").drawImage(this.element,0,0,b,c);dataSrc=f.get(0).toDataURL("image/png");f.remove();return dataSrc}}},flash:{supported:swfobject&&swfobject.hasFlashPlayerVersion("11.2.0"),id:null,create:function(){var b=this;this.id="flash-webcam-recorder-"+window.guid();window.statechange=function(c){b.state=c;console.log("statechange",c);b.trigger(a.Event("recorder:state:"+
c),b.element)};var c=a('<div><div id="'+this.id+'" /></div>');b.trigger(a.Event("recorder:create"),c);var d=setInterval(function(){a("#"+b.id).inDOM()&&(swfobject.embedSWF(b.options.flash.swf_url,b.id,640,480,"11.2.0",!1,{},{allowscriptaccess:"always",wmode:"opaque"},{},function(a){a.success&&(b.element=a.ref)}),clearInterval(d))},100);console.log("create",this)},start:function(){var b=this;if("ready"==this.state||"error"==this.state||"permissionerror"==this.state)return ret=this.element.startcam();
this.one("recorder:state:ready",function(a){a.stopPropagation();b.start()})},stop:function(){try{return this.element.stopcam()}catch(a){}},snapshot:function(){return this.element.snapshot().split("\r").join("").split("\n").join("")}}};for(e in g)if(g[e].supported){a.extend(a.fn.recorder.prototype,g[e]);a.recorder.supported=!0;break}})(jQuery,window);
