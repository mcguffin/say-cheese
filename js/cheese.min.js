...
this,a)}});wp.media.cheese.view.DataSourceImageGrabber=wp.media.View.extend({tagName:"div",className:"image-grabber",_grabber:null,_uploader:null,initialize:function(){_.defaults(this.options,{grabber:wp.media.cheese.view.WebcamRecorder});var a=this.options.grabber==wp.media.cheese.view.WebcamRecorder?c.snapshot:this.options.grabber==wp.media.cheese.view.Pasteboard?c.pasted:c.image,b=this.options.grabber==wp.media.cheese.view.WebcamRecorder?c.take_snapshot:this.options.grabber==wp.media.cheese.view.Pasteboard?
c.copy_paste:c.image,d=new wp.media.View({className:"image-grabber-content",tagName:"div",controller:this.controller}),e=new wp.media.View({className:"media-frame-title",tagName:"div"}),f=new wp.media.View({tagName:"h1"});this._grabber=new this.options.grabber({controller:this.controller});this._uploader=new wp.media.cheese.view.DataSourceImageUploader({controller:this.controller,defaultFileName:a});d.views.add(this._grabber);d.views.add(this._uploader);f.$el.text(b);e.views.add(f);this.views.add(e);
this.views.add(d);this.controller.on("action:create:dataimage",this.imageCreated,this);this.controller.on("action:discard:dataimage",this.startGrabbing,this)},imageCreated:function(a,b){this._grabber.stop().hide();this._uploader.show().setImageData(b)},startGrabbing:function(){this._uploader.hide();this._grabber.show().start();return this},getAction:function(){return this._grabber.action},dismiss:function(){this._grabber.stop();return this}});wp.media.cheese.view.GrabberButton=e.extend({className:"grabber-button",
_grabber:null,_modal:null,initialize:function(a){e.prototype.initialize.apply(this,arguments);var b;_.defaults(this.options,{grabber:null,title:"Image Grabber"});this._grabber=new wp.media.cheese.view.DataSourceImageGrabber({controller:this.controller,grabber:this.options.grabber});this._modal=new h({controller:d(),title:this.options.title});this._modal.content(this._grabber);b=this._grabber.getAction();this.controller.on(b+":activate "+b+":deactivate",this.toggleModeHandler,this);this.controller.on(b+
":action:done",this.back,this);this.controller.on("action:uploaded:dataimage",this.uploadDone,this);this.controller.on("error:uploaded:dataimage",this.uploadDone,this);this._modal.on("close",this.back,this)},uploadDone:function(){this._modal.close()},back:function(){this._grabber.dismiss();this.controller.deactivateMode(this._grabber.getAction()).activateMode("edit")},click:function(){e.prototype.click.apply(this,arguments);this.controller.isModeActive(this._grabber.getAction())||(this.controller.deactivateMode("edit").activateMode(this._grabber.getAction()),
this._modal.open(),this._grabber.startGrabbing())}})})(jQuery,window,mOxie);
