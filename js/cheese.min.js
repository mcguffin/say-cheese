...
(function(c,k){c.fn.outerHTML||c.extend(c.fn,{outerHTML:function(){return c("<div>").append(this.clone()).html()}});c.fn.inDOM||c.extend(c.fn,{inDOM:function(){return jQuery.contains(document,this[0])}});var d=null,e,l=0;k.guid=function(){var a=(new Date).getTime().toString(32),b;for(b=0;5>b;b++)a+=Math.floor(65535*Math.random()).toString(32);return"p"+a+(l++).toString(32)};window.URL=window.URL||window.webkitURL||window.mozURL||window.msURL;navigator.mediaDevices&&navigator.mediaDevices.getUserMedia?
navigator.getUserMedia=function(a,b,c){a=navigator.mediaDevices.getUserMedia(a);a.then(b);a["catch"](c)}:(console.log("hier!"),navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia);c.extend(c,{recorder:{supported:!1}});c.fn.recorder=function(a){var b=this;c.extend(this,c.fn.recorder.prototype);this.options=c.extend(!0,{camera:!0,microphone:!1,width:640,height:480,flash:{swf_url:"WebcamRecorder.swf"},html5:{},autostart:!1},
a);this.on("recorder:create",function(a,h){b.element||(b.element=h,c(h).appendTo(b).get(0))});this.create();return this};c.extend(c.fn.recorder.prototype,{element:null,state:!1,create:function(){},start:function(){},stop:function(){},snapshot:function(){}});var g={html5:{supported:!(!window.URL||!window.URL.createObjectURL)&&function(){var a=document.createElement("canvas");return!(!a.getContext||!a.getContext("2d"))}()&&!!navigator.getUserMedia,create:function(){var a=this,b="html5-webcam-recorder-"+
window.guid(),b='<video class="webcam-recorder" width="'+a.options.width+'" height="'+a.options.height+'" id="'+b+'" autoplay="autoplay"></video>';this.trigger(c.Event("recorder:create"),c(b).get(0));setTimeout(function(){a.trigger(c.Event("recorder:state:ready"),a.element,"ready")},20)},start:function(){var a=this;navigator.getUserMedia({video:this.options.camera,audio:this.options.microphone},function(b){void 0!==this.element.mozSrcObject?this.element.mozSrcObject=b:this.element.src=window.URL&&
window.URL.createObjectURL(b)||b;d=b;c(this.element).on("playing",function(b){self.state="started";a.trigger(c.Event("recorder:state:started"),a.element)})}.bind(this),function(b){a.state="error";1===b.code||"PermissionDeniedError"==b.name?a.trigger(c.Event("recorder:state:permissionerror"),[a.element,b]):a.trigger(c.Event("recorder:state:error"),[a.element,b])});this.state="waiting";this.trigger(c.Event("recorder:state:waiting"),this.element)},stop:function(){console.log(d);var a,b;if(d&&d.stop)d.stop();
else if(d.getVideoTracks)for(b in a=d.getVideoTracks(),a)a[b].stop&&a[b].stop();c(this.element).off("playing");this.element.src=null;this.state="stopped";this.trigger(c.Event("recorder:state:stopped"),this.element)},snapshot:function(){var a,b;a=this.element.videoWidth||this.width();b=this.element.videoHeight||this.height();if(d){var f=c('<canvas style="display:block"></canvas>').insertAfter(this).attr("width",a).attr("height",b);f.get(0).getContext("2d").drawImage(this.element,0,0,a,b);dataSrc=f.get(0).toDataURL("image/png");
f.remove();return dataSrc}}},flash:{supported:swfobject&&swfobject.hasFlashPlayerVersion("11.2.0"),id:null,create:function(){var a=this;this.id="flash-webcam-recorder-"+window.guid();window.statechange=function(b){a.state=b;console.log("statechange",b);a.trigger(c.Event("recorder:state:"+b),a.element)};var b=c('<div><div id="'+this.id+'" /></div>');a.trigger(c.Event("recorder:create"),b);var d=setInterval(function(){c("#"+a.id).inDOM()&&(swfobject.embedSWF(a.options.flash.swf_url,a.id,640,480,"11.2.0",
!1,{},{allowscriptaccess:"always",wmode:"opaque"},{},function(b){b.success&&(a.element=b.ref)}),clearInterval(d))},100);console.log("create",this)},start:function(){var a=this;if("ready"==this.state||"error"==this.state||"permissionerror"==this.state)return ret=this.element.startcam();this.one("recorder:state:ready",function(b){b.stopPropagation();a.start()})},stop:function(){try{return this.element.stopcam()}catch(a){}},snapshot:function(){return this.element.snapshot().split("\r").join("").split("\n").join("")}}};
for(e in g)if(g[e].supported){c.extend(c.fn.recorder.prototype,g[e]);c.recorder.supported=!0;break}})(jQuery,window);
(function(b){(function(a,f){b.Event.call(this,a);this.dataurl=f;this.stopPropagation()}).prototype=new b.Event("");b.fn.extend({imagepastebox:function(a){var f=this,g={messages:{no_image_pasted:"No image data pasted.",no_processible_image_pasted:"Your Browser does not support pasting processible image data."}};if("off"==a)return this.off("paste").off("blur").off("keydown").removeAttr("contenteditable","true").blur();g=b.extend(a,g);this.on("paste",function(c){var d=c.clipboardData||c.originalEvent.clipboardData,
...
a.target.result)},reader.readAsDataURL(e),!1;e=d.getData(a);if(a.match(/image.*/))return h(c),!1;if(matches=e.match(/(^|src=")(data:.*)("|$)/))return f.trigger("pasteimage",matches[2]),!1;"text/html"==a&&(e.match(/<img/)?h(c):f.text(g.messages.no_image_pasted))}):h(c);k||c.preventDefault()}).attr("contenteditable","true").on("keydown",function(a){b(this).text("")}).on("blur",function(a){var d=this;setTimeout(function(){b(d).focus()},10)});setTimeout(function(){f.focus()},10);return this}})})(jQuery);
(function(d,e){var a=wp.media,f=a.view.MediaFrame.Select.prototype.bindHandlers,g=a.view.MediaFrame.Select.prototype.browseRouter,b=a.view.l10n="undefined"===typeof _wpMediaViewsL10n?{}:_wpMediaViewsL10n;is_safari=!(-1<navigator.userAgent.indexOf("Chrome"))&&-1<navigator.userAgent.indexOf("Safari");b=_.extend(b,cheese_l10n);d.extend(wp.Uploader.prototype,{success:function(a){}});var c={supports:{paste:!is_safari&&cheese_l10n.enable_pasteboard&&("paste"in document||"onpaste"in document||"object"===
typeof window.onpaste),webcam_recording:cheese_l10n.enable_snapshot&&d.recorder.supported},create_webcam_recorder:function(a,b){d.extend(!0,b||{},{camera:{mandatory:{minWidth:640,minHeight:480}},microphone:!1});return d(a).recorder(b)}};a.view.MediaFrame.Select.prototype.browseRouter=function(a){g.apply(this,arguments);c.supports.webcam_recording&&a.set({record:{text:b.webcam_record,priority:30}});c.supports.paste&&a.set({pasteboard:{text:b.copy_paste,priority:35}})};a.view.MediaFrame.Select.prototype.bindHandlers=
function(){var a=!1;f.apply(this,arguments);this.on("content:render close",function(b){a&&"function"===typeof a.dismiss&&a.dismiss();"undefined"!==typeof b&&(a=b)},this);this.on("content:create:pasteboard",this.contentCreatePasteboard,this);this.on("content:create:record",this.contentCreateRecord,this);this.on("content:render:pasteboard content:render:record",this.contentRenderGrabber,this);frame=this};a.view.MediaFrame.Select.prototype.contentCreateRecord=function(b){this.state();this.$el.removeClass("hide-toolbar");
b.view=new a.view.DataSourceImageGrabber({controller:this,grabber:a.view.WebcamRecorder})};a.view.MediaFrame.Select.prototype.contentCreatePasteboard=function(b){this.state();this.$el.removeClass("hide-toolbar");b.view=new a.view.DataSourceImageGrabber({controller:this,grabber:a.view.Pasteboard})};a.view.MediaFrame.Select.prototype.contentRenderGrabber=function(a){a.startGrabbing()};var h=a.view.AttachmentsBrowser.prototype.initialize;a.view.AttachmentsBrowser.prototype.initialize=function(){h.apply(this,
arguments);this.controller instanceof a.view.MediaFrame.Select||(c.supports.paste&&this.toolbar.set("pasteModeButton",(new wp.media.view.GrabberButton({text:b.copy_paste,controller:this.controller,priority:-65,grabber:a.view.Pasteboard})).render()),c.supports.webcam_recording&&this.toolbar.set("recordModeButton",(new wp.media.view.GrabberButton({text:b.take_snapshot,controller:this.controller,priority:-64,grabber:a.view.WebcamRecorder})).render()))};e.cheese=c})(jQuery,window);
(function(d,n,k){var a=wp.media,h=a.view.Button,l=a.view.Modal,c=a.view.l10n="undefined"===typeof _wpMediaViewsL10n?{}:_wpMediaViewsL10n,e,f,c=_.extend(c,cheese_l10n),m=wp.media.view.MediaFrame.prototype.initialize;wp.media.view.MediaFrame.prototype.initialize=function(){e=this;m.apply(this,arguments)};a.view.NameInput=a.View.extend({tagName:"label",className:"setting",_input:null,initialize:function(){_.defaults(this.options,{defaultValue:"untitled",title:c.title});this._input=d('<input class="alignment" type="text" data-setting="title" />');
this.$el.append("<span>"+this.options.title+"</span>").append(this._input)},render:function(){this._input.val()||this._input.val(this.options.defaultValue)},val:function(){return this._input.val()||this.options.defaultValue}});a.view.ActionButton=a.view.Button.extend({dashicon:"yes",render:function(){_.defaults(this.options,{dashicon:"yes"});a.view.Button.prototype.render.apply(this,arguments);this.$el.addClass("button-action");this.$el.prepend('<span class="dashicons dashicons-'+this.options.dashicon+
'"></span>');this.model.disabled?this.$el.addClass("disabled"):this.$el.removeClass("disabled")}});a.view.DataSourceImageUploader=a.View.extend({tagName:"div",className:"data-source-image",controller:null,image:null,discardBtn:null,nameInput:null,uploadBtn:null,uploader:null,_model:{},initialize:function(){_.defaults(this.options,{defaultFileName:c.image});var b=this;f=this;var g=new a.View({tagName:"div",className:"instruments",controller:this});this.discardBtn=new a.view.ActionButton({className:"image-discard",
style:"secondary",text:c.try_again,dashicon:"arrow-left",controller:this,click:function(){b.discardImage.apply(b,arguments)}});this.nameInput=new a.view.NameInput({defaultValue:this.options.defaultFileName});this.uploadBtn=new a.view.ActionButton({className:"image-upload",style:"primary",text:c.upload,controller:this,click:function(){b.uploadImage.apply(b,arguments)}});this.views.add(g);g.views.add(this.discardBtn);g.views.add(this.nameInput);g.views.add(this.uploadBtn);this.$imageContainer=!1},setImageData:function(b){var a=
this.$el.find(".image-container").html("").get(0);this.image&&this.image.destroy();this.image=new k.Image;this.image.onload=function(){var b=e.uploader.uploader.uploader.getOption("resize"),c=Math.max(b.width/this.width,b.height/this.height);b&&1>c&&this.downsize(this.width*c,this.height*c);this.embed(a)};this.image.bind("Resize",function(b){this.embed(a)});this.image.load(b);this.$imageContainer&&this.$imageContainer.append(this.image);this.disabled(!1);return this},render:function(){this.$imageContainer=
d('<span class="image-container" />');this.$el.prepend(this.$imageContainer)},discardImage:function(){this.controller.trigger("action:discard:dataimage",this)},uploadImage:function(){this.bindEvents();var b=this.image.getAsBlob("image/png");new wp.Uploader;b.detach(b.getSource());b.name=this.nameInput.val()+".png";e.uploader.uploader.uploader.addFile(b,this.nameInput.val()+".png");this.disabled(!0)},show:function(){this.$el.show();return this},hide:function(){this.$el.hide();return this},disabled:function(b){this.uploadBtn.model.disabled=
this.discardBtn.model.disabled=b;this.uploadBtn.render();this.discardBtn.render()},_uploadSuccessHandler:function(){f.controller.trigger("action:uploaded:dataimage");f.disabled(!1)},_uploadErrorHandler:function(){f.controller.trigger("error:uploaded:dataimage");f.disabled(!1)},bindEvents:function(){e.uploader.uploader.uploader.bind("FileUploaded",this._uploadSuccessHandler);e.uploader.uploader.uploader.bind("Error",this._uploadErrorHandler)}});a.view.WebcamRecorder=a.View.extend({tagName:"div",className:"webcam-recorder",
controller:null,action:"record",_webcam:null,_recorder:null,_instruments:null,initialize:function(){_.defaults(this.options,{});var b=this;this._recorder=d('<div class="recorder"></div>').appendTo(this.$el).on("click",".recorder-record",function(a){a.preventDefault();b.controller.trigger("action:create:dataimage",b,b._webcam.snapshot());b.stop();return!1});this._instruments=d('<div class="instruments"><a href="#" class="button recorder-record button-primary button-action"><span class="dashicons dashicons-video-alt2"></span>'+
c.record+"</a></div>").appendTo(this._recorder);this.$el.on("click",".error-try-again",function(){b.start();b.$el.find(".error").remove()});if(!this._webcam){var a={camera:{mandatory:{minWidth:640,minHeight:480}},microphone:!1,flash:{swf_url:c.swf_url}};this._webcam=d(this._recorder).recorder(a);this._webcam.on("recorder:state:ready",function(b){});this._webcam.on("recorder:state:waiting",function(a){b._instruments.hide()});this._webcam.on("recorder:state:started",function(a){b._instruments.show()});
this._webcam.on("recorder:state:error",function(a){b.$el.append('<div class="error recorder-inline-content"><h3>'+c.an_error_occured+'</h3><p><a class="error-try-again" href="#">'+c.try_again+"</a></p></div>");b._instruments.hide()});this._webcam.on("recorder:state:permissionerror",function(a,g,d){console.log(arguments);b.$el.append('<div class="error recorder-inline-content"><h3>'+(d.message||c.please_allow_camera_message)+'</h3><p><a class="error-try-again" href="#">'+c.try_again+"</a></p></div>");
b._instruments.hide()});this._webcam.on("recorder:state:stopped",function(a){b._instruments.hide()})}this._instruments.hide()},get_state:function(){return this._webcam.state},start:function(){this._recorder.is(":visible")||this._recorder.show();this._webcam.start();return this},stop:function(){this._webcam.stop();this._recorder.is(":visible")&&this._recorder.hide();return this},show:function(){this.$el.show();return this},hide:function(){this.$el.hide();return this}});a.view.Pasteboard=a.View.extend({tagName:"div",
className:"pasteboard",controller:null,action:"paste",_content:null,_pasteboard:null,initialize:function(){_.defaults(this.options,{});this._content=d('<div class="pasteboard-inline-content"><h3>'+c.paste_instructions+"</h3></div>").appendTo(this.$el);this._pasteboard=d('<div id="pasteboard-injector"></div>').appendTo(this._content)},start:function(){var a=this;this._pasteboard.imagepastebox({messages:{no_image_pasted:c.paste_error_no_image,no_processible_image_pasted:c.paste_error_webkit_fake_image}}).on("pasteimage",
"",function(c,d){a.controller.trigger("action:create:dataimage",a,d);return!1}).focus();this._content.show();return this},stop:function(){this._pasteboard.imagepastebox("off").off("pasteimage");this._content.hide();return this},show:function(){this.$el.show();return this},hide:function(){this.$el.hide();return this}});a.view.DataSourceImageGrabber=a.View.extend({tagName:"div",className:"image-grabber",_grabber:null,_uploader:null,initialize:function(){_.defaults(this.options,{grabber:a.view.WebcamRecorder});
var b=this.options.grabber==a.view.WebcamRecorder?c.snapshot:this.options.grabber==a.view.Pasteboard?c.pasted:c.image,g=this.options.grabber==a.view.WebcamRecorder?c.take_snapshot:this.options.grabber==a.view.Pasteboard?c.copy_paste:c.image,d=new a.View({className:"image-grabber-content",tagName:"div",controller:this}),e=new a.View({className:"media-frame-title",tagName:"div"}),f=new a.View({tagName:"h1"});this._grabber=new this.options.grabber({controller:this});this._uploader=new a.view.DataSourceImageUploader({controller:this,
defaultFileName:b});d.views.add(this._grabber);d.views.add(this._uploader);f.$el.text(g);e.views.add(f);this.views.add(e);this.views.add(d);this.on("action:create:dataimage",this.imageCreated);this.on("action:discard:dataimage",this.startGrabbing);this.on("action:uploaded:dataimage",this.imageUploaded);this.on("error:uploaded:dataimage",this.imageUploadError)},imageCreated:function(a,c){this._grabber.stop().hide();this._uploader.show().setImageData(c)},startGrabbing:function(){this._uploader.hide();
this._grabber.show().start();return this},imageUploaded:function(){this.controller.trigger("action:uploaded:dataimage")},imageUploadError:function(){this.controller.trigger("error:uploaded:dataimage")},getAction:function(){return this._grabber.action},dismiss:function(){this._grabber.stop();return this}});a.view.GrabberButton=h.extend({className:"grabber-button",_grabber:null,_modal:null,initialize:function(b){h.prototype.initialize.apply(this,arguments);var c;_.defaults(this.options,{grabber:null,
title:"Image Grabber"});this._grabber=new a.view.DataSourceImageGrabber({controller:this.controller,grabber:this.options.grabber});this._modal=new l({controller:d(),title:this.options.title});this._modal.content(this._grabber);c=this._grabber.getAction();this.listenTo(this.controller,c+":activate "+c+":deactivate",this.toggleModeHandler);this.listenTo(this.controller,c+":action:done",this.back);this.listenTo(this.controller,"action:uploaded:dataimage",this.uploadDone);this.listenTo(this.controller,
"error:uploaded:dataimage",this.uploadDone);this.listenTo(this._modal,"close",this.back)},uploadDone:function(){this._grabber.dismiss();this._modal.close()},back:function(){this._grabber.dismiss();this.controller.deactivateMode(this._grabber.getAction()).activateMode("edit")},click:function(){h.prototype.click.apply(this,arguments);this.controller.isModeActive(this._grabber.getAction())||(this.controller.deactivateMode("edit").activateMode(this._grabber.getAction()),this._modal.open(),this._grabber.startGrabbing())}})})(jQuery,
window,mOxie);
