...
(function(c,d){var b=wp.media.view.l10n="undefined"===typeof _wpMediaViewsL10n?{}:_wpMediaViewsL10n;is_safari=!(-1<navigator.userAgent.indexOf("Chrome"))&&-1<navigator.userAgent.indexOf("Safari");c.extend(wp.Uploader.prototype,{success:function(a){}});_.extend(wp.media.view.MediaFrame.Select.prototype,{_parentBrowseRouter:wp.media.view.MediaFrame.Select.prototype.browseRouter,browseRouter:function(a){this._parentBrowseRouter.apply(this,arguments);cheese.supports.webcam_recording&&a.set({record:{text:b.webcam_record,
priority:30}});cheese.supports.paste&&a.set({pasteboard:{text:b.copy_paste,priority:35}})},_parentBindHandlers:wp.media.view.MediaFrame.Select.prototype.bindHandlers,bindHandlers:function(){var a=!1;bindHandlers.apply(this,arguments);this.on("content:render close",function(b){a&&"function"===typeof a.dismiss&&a.dismiss();"undefined"!==typeof b&&(a=b)},this);this.on("content:create:pasteboard",this.contentCreatePasteboard,this);this.on("content:create:record",this.contentCreateRecord,this);this.on("content:render:pasteboard content:render:record",
this.contentRenderGrabber,this);this.on("action:uploaded:dataimage",this.uploadedDataImage,this);frame=this},contentCreateRecord:function(a){this.state();a.view=new media.view.DataSourceImageGrabber({controller:this,grabber:wp.media.cheese.view.WebcamRecorder})},contentCreatePasteboard:function(a){this.state();a.view=new media.view.DataSourceImageGrabber({controller:this,grabber:wp.media.cheese.view.Pasteboard})},contentRenderGrabber:function(a){a.startGrabbing()},uploadedDataImage:function(a){}});
_.extend(wp.media.view.AttachmentsBrowser.prototype,{_parentInitialize:wp.media.view.AttachmentsBrowser.prototype.initialize,initialize:function(){this._parentInitialize.apply(this,arguments);this.controller instanceof wp.media.view.MediaFrame.Select||(wp.media.cheese.supports.paste&&this.toolbar.set("pasteModeButton",(new wp.media.cheese.view.GrabberButton({text:b.copy_paste,controller:this.controller,priority:-65,grabber:wp.media.cheese.view.Pasteboard})).render()),wp.media.cheese.supports.webcam_recording&&
this.toolbar.set("recordModeButton",(new wp.media.cheese.view.GrabberButton({text:b.take_snapshot,controller:this.controller,priority:-64,grabber:wp.media.cheese.view.WebcamRecorder})).render()))}})})(jQuery,window);
(function(c,m,h){var f=wp.media.view.Button,k=wp.media.view.Modal,b=wp.media.view.l10n="undefined"===typeof _wpMediaViewsL10n?{}:_wpMediaViewsL10n,d,g,b=_.extend(b,cheese_l10n),l=wp.media.view.MediaFrame.prototype.initialize;wp.media.view.MediaFrame.prototype.initialize=function(){d=this;l.apply(this,arguments)};wp.media.cheese.view.NameInput=wp.media.View.extend({tagName:"label",className:"setting",_input:null,initialize:function(){_.defaults(this.options,{defaultValue:"untitled",title:b.title});
this._input=c('<input class="alignment" type="text" data-setting="title" />');this.$el.append("<span>"+this.options.title+"</span>").append(this._input)},render:function(){this._input.val()||this._input.val(this.options.defaultValue)},val:function(){return this._input.val()||this.options.defaultValue}});wp.media.cheese.view.ActionButton=f.extend({dashicon:"yes",render:function(){_.defaults(this.options,{dashicon:"yes"});var a=wp.media.view.Button.prototype.render.apply(this,arguments);this.$el.addClass("button-action");
this.$el.prepend('<span class="dashicons dashicons-'+this.options.dashicon+'"></span>');this.model.disabled?this.$el.addClass("disabled"):this.$el.removeClass("disabled");return a}});wp.media.cheese.view.DataSourceImageUploader=wp.media.View.extend({tagName:"div",className:"data-source-image",controller:null,image:null,discardBtn:null,nameInput:null,uploadBtn:null,uploader:null,_model:{},initialize:function(){_.defaults(this.options,{defaultFileName:b.image});var a=this;g=this;var e=new wp.media.View({tagName:"div",
className:"instruments",controller:this.controller});this.discardBtn=new wp.media.cheese.view.ActionButton({className:"image-discard",style:"secondary",text:b.try_again,dashicon:"arrow-left",controller:this.controller,click:function(){a.discardImage.apply(a,arguments)}});this.nameInput=new wp.media.cheese.view.NameInput({defaultValue:this.options.defaultFileName});this.uploadBtn=new wp.media.cheese.view.ActionButton({className:"image-upload",style:"primary",text:b.upload,controller:this.controller,
click:function(){a.uploadImage.apply(a,arguments)}});this.views.add(e);e.views.add(this.discardBtn);e.views.add(this.nameInput);e.views.add(this.uploadBtn);this.$imageContainer=!1},setImageData:function(a){var b=this.$el.find(".image-container").html("").get(0);this.image&&this.image.destroy();this.image=new h.Image;this.image.onload=function(){var a=d.uploader.uploader.uploader.getOption("resize"),c=Math.max(a.width/this.width,a.height/this.height);a&&1>c&&this.downsize(this.width*c,this.height*
c);this.embed(b)};this.image.bind("Resize",function(a){this.embed(b)});this.image.load(a);this.$imageContainer&&this.$imageContainer.append(this.image);this.disabled(!1);return this},render:function(){this.$imageContainer=c('<span class="image-container" />');this.$el.prepend(this.$imageContainer)},discardImage:function(){this.controller.trigger("action:discard:dataimage",this)},uploadImage:function(){this.bindEvents();var a=this.image.getAsBlob("image/png");a.detach(a.getSource());a.name=this.nameInput.val()+
".png";d.uploader.uploader.uploader.addFile(a,this.nameInput.val()+".png");this.disabled(!0);this.controller.trigger("action:upload:dataimage",this)},show:function(){this.$el.show();return this},hide:function(){this.$el.hide();return this},disabled:function(a){this.uploadBtn.model.disabled=this.discardBtn.model.disabled=a;this.uploadBtn.render();this.discardBtn.render()},_uploadSuccessHandler:function(){this.controller.trigger("action:uploaded:dataimage");g.disabled(!1)},_uploadErrorHandler:function(){this.controller.trigger("error:uploaded:dataimage");
g.disabled(!1)},bindEvents:function(){d.uploader.uploader.uploader.bind("FileUploaded",this._uploadSuccessHandler,this);d.uploader.uploader.uploader.bind("Error",this._uploadErrorHandler,this)}});wp.media.cheese.view.WebcamRecorder=wp.media.View.extend({tagName:"div",className:"webcam-recorder",controller:null,action:"record",_webcam:null,_recorder:null,_instruments:null,initialize:function(){_.defaults(this.options,{});var a=this;this._recorder=c('<div class="recorder"></div>').appendTo(this.$el).on("click",
".recorder-record",function(b){b.preventDefault();a.controller.trigger("action:create:dataimage",a,a._webcam.snapshot());a.stop();return!1});this._instruments=c('<div class="instruments"><a href="#" class="button recorder-record button-primary button-action"><span class="dashicons dashicons-video-alt2"></span>'+b.record+"</a></div>").appendTo(this._recorder);this.$el.on("click",".error-try-again",function(){a.start();a.$el.find(".error").remove()});if(!this._webcam){var e={camera:{mandatory:{minWidth:640,
minHeight:480}},microphone:!1,flash:{swf_url:b.swf_url}};this._webcam=c(this._recorder).recorder(e);this._webcam.on("recorder:state:ready",function(a){});this._webcam.on("recorder:state:waiting",function(b){a._instruments.hide()});this._webcam.on("recorder:state:started",function(b){a._instruments.show()});this._webcam.on("recorder:state:error",function(e){a.$el.append('<div class="error recorder-inline-content"><h3>'+b.an_error_occured+'</h3><p><a class="error-try-again" href="#">'+b.try_again+"</a></p></div>");
a._instruments.hide()});this._webcam.on("recorder:state:permissionerror",function(e,c,d){a.$el.append('<div class="error recorder-inline-content"><h3>'+(d.message||b.please_allow_camera_message)+'</h3><p><a class="error-try-again" href="#">'+b.try_again+"</a></p></div>");a._instruments.hide()});this._webcam.on("recorder:state:stopped",function(b){a._instruments.hide()})}this._instruments.hide()},get_state:function(){return this._webcam.state},start:function(){this._recorder.is(":visible")||this._recorder.show();
...
b.image,e=this.options.grabber==wp.media.cheese.view.WebcamRecorder?b.take_snapshot:this.options.grabber==wp.media.cheese.view.Pasteboard?b.copy_paste:b.image,c=new wp.media.View({className:"image-grabber-content",tagName:"div",controller:this.controller}),d=new wp.media.View({className:"media-frame-title",tagName:"div"}),f=new wp.media.View({tagName:"h1"});this._grabber=new this.options.grabber({controller:this.controller});this._uploader=new wp.media.cheese.view.DataSourceImageUploader({controller:this.controller,
defaultFileName:a});c.views.add(this._grabber);c.views.add(this._uploader);f.$el.text(e);d.views.add(f);this.views.add(d);this.views.add(c);this.controller.on("action:create:dataimage",this.imageCreated,this);this.controller.on("action:discard:dataimage",this.startGrabbing,this)},imageCreated:function(a,b){this._grabber.stop().hide();this._uploader.show().setImageData(b)},startGrabbing:function(){this._uploader.hide();this._grabber.show().start();return this},getAction:function(){return this._grabber.action},
dismiss:function(){this._grabber.stop();return this}});wp.media.cheese.view.GrabberButton=f.extend({className:"grabber-button",_grabber:null,_modal:null,initialize:function(a){f.prototype.initialize.apply(this,arguments);var b;_.defaults(this.options,{grabber:null,title:"Image Grabber"});this._grabber=new wp.media.cheese.view.DataSourceImageGrabber({controller:this.controller,grabber:this.options.grabber});this._modal=new k({controller:c(),title:this.options.title});this._modal.content(this._grabber);
b=this._grabber.getAction();this.controller.on(b+":activate "+b+":deactivate",this.toggleModeHandler,this);this.controller.on(b+":action:done",this.back,this);this.controller.on("action:uploaded:dataimage",this.uploadDone,this);this.controller.on("error:uploaded:dataimage",this.uploadDone,this);this._modal.on("close",this.back,this)},uploadDone:function(){this._modal.close()},back:function(){this._grabber.dismiss();this.controller.deactivateMode(this._grabber.getAction()).activateMode("edit")},click:function(){f.prototype.click.apply(this,
